...
if (student.value.match(validUnits)) {
  ...
  studLabel.innerHTML += " <label style='color:#BF565A'>Invalid Room Number!</label>"
  student.style.border = "1px solid #BF565A";
  return false;
  }
}
